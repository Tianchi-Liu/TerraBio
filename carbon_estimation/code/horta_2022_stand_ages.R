...
dataall_TB <- merge(
  dataGEE_TB, dataCEOYR_TB[,c(5, 12, 16, 18, 22, 32, 26)],
...
dataSBP_TB<- merge(
  dataall_TB, dataStrata_TB[c(3, 2, 4)], 
...
## convert CEO establishment year info to stand age in 2021 ####
dataSBP_TB$standAge_2021_CEOestYr = 2021 - dataSBP_TB$establishment.year
...
## CEO most recent land cover, year of loss and gain 
standAge_estYr = data_standAge_df$standAge_2021_CEOestYr
standAge_logic = data_standAge_df$'2021' 
ggplot(data_standAge_df, aes(x=standAge_logic, y=standAge_2021_CEOestYr)) +
  geom_point(alpha=0.5, position='jitter') +
  xlab('based on 2021 LC, year of loss and gain') +
  ylab('based on establishment year') +
